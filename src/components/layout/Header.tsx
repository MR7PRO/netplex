          ...
          <Link to="/" className="flex items-center gap-3 shrink-0 group">
            <div className="relative">
              <img 
                src={logoImage} 
                alt="NetPlex" 
                className="w-14 h-14 sm:w-16 sm:h-16 object-contain transition-all duration-300 group-hover:scale-110 group-hover:drop-shadow-[0_0_12px_rgba(225,6,0,0.7)]" 
              />
            ...
            <span className="font-bold text-lg sm:text-xl hidden sm:block tracking-tight transition-colors duration-300" dir="ltr">
              <span className="text-foreground">N</span>et<span className="text-primary">P</span>lex
            </span>
          </Link>
