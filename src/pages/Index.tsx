        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-2 md:mb-4">
              ...
              <span className="block mt-2 text-lg md:text-2xl lg:text-3xl font-semibold text-muted-foreground animate-red-glow">
            ...
            <p className="text-base md:text-lg lg:text-xl text-muted-foreground mb-6 md:mb-8 px-4 animate-red-glow-delayed">
