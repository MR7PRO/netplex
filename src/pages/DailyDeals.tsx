...
const DailyDealsPage: React.FC = () => {
  ...
  return (
    <Layout>
      <SEO title="صفقات اليوم 🔥 — أفضل الأسعار | NetPlex" description="صفقات اليوم في NetPlex: خصومات حصرية وأسعار محدودة على الإلكترونيات والسلع في قطاع غزة." path="/daily-deals" />
